...
export const {
    ...
    userLogOutReceive,
    userLogOutError,
    checkUserIsAuthStart,
    checkUserIsAuthError,
    checkUserIsAuthReceive,
    forgotPasswordStart,
    ...
    types.CHECK_USER_IS_AUTH_START,
    types.CHECK_USER_IS_AUTH_ERROR,
    types.CHECK_USER_IS_AUTH_RECEIVE,
